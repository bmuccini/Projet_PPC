...
import time
from shared_memory import create_shared_memory  # Importer la mémoire partagée
...
def gerer_traffic(queue_nord, queue_sud, queue_est, queue_ouest, shared_lights):
...
if __name__ == "__main__":
    ...
    gerer_traffic(queue_nord, queue_sud, queue_est, queue_ouest, shared_lights)  # Démarrage gestion du trafic